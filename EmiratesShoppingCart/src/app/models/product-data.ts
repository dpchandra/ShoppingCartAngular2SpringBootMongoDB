import { Product } from './Product';
  ...
  export const PRODUCTS:Product[] = [
      { uid: 1, name: 'Nexus S', src: "/assets/img/phones/nexus-s.0.jpg", price: 99.99, 
      ...
      { uid: 2, name: 'Dell Venue', src: "/assets/img/phones/dell-venue.0.jpg", price: 109.99,
      ...
      { uid: 3, name: 'Droid 2', src: "/assets/img/phones/droid-2-global-by-motorola.0.jpg", price: 89.99,
      ...
      { uid: 4, name: 'Droid Pro', src: "/assets/img/phones/droid-pro-by-motorola.0.jpg", price: 129.99,
      ...
      { uid: 5, name: 'Motorola Bravo', src: "/assets/img/phones/motorola-bravo-with-motoblur.0.jpg", price: 119.99,
      ...
      { uid: 6, name: 'Motorola Defy', src: "/assets/img/phones/motorola-defy-with-motoblur.0.jpg", price: 139.99,
